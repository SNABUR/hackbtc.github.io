  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center font-hacker justify-center">
      <div className="flex flex-col bg-white shadow-lg rounded-lg p-8 w-full max-w-md items-center">
        ...
        <button
          className="bg-purple-600 text-white py-2 px-4 rounded-lg mt-1 hover:bg-blue-700 transition w-64 active:scale-95 duration-200"
        ...
        <div className="w-full mt-6">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            >
              <Image src={etherscan.src} alt="Etherscan" width={26} height={26} />
            </a>
          </div>
        </div>
